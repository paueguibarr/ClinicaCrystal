 ...
 * @author paueguibar
 */
public class CuentaQuirofanoR extends javax.swing.JFrame {
    Conectar conn;
    PreparedStatement pst;
    ResultSet rs;
    /**
     * Creates new form CuentaQuirofanoR
     */
    public CuentaQuirofanoR() {
        initComponents();
        conn = new Conectar();
        loadPaciente();
        loadMateriales();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CuentaQuirofanoR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CuentaQuirofanoR().setVisible(true);
            }
        });
    }
