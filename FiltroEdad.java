 ...
 * @author paueguibar
 */
public class FiltroEdad extends javax.swing.JFrame {
    Conectar conn;
    ...
    public void createTable(String e) {
        //display pacientes from that age
        try {
            pst = conn.getConnection().prepareStatement("select * from Paciente where edad = ?");
            pst.setString(1, e);           
            rs = pst.executeQuery();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FiltroEdad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FiltroEdad().setVisible(true);
            }
        });
    }
